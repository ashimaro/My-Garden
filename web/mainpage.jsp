<%-- 
    Document   : mainpage
    Created on : Mar 24, 2023, 11:00:28 PM
    Author     : Ashi
--%>
                    ...
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                        <div class="right-product-box">
                            ...
                            <%
                                ...
                                List<Product> listProduct = pdDao.retrieveAllProduct();
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="displayImage.jsp?autoIndex=<%=pd.getAutoindex() %>" class="img-fluid" alt="Image">
                                                        <div class="mask-icon">
                                                            <ul>
